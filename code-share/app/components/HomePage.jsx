...
function HomePage() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-full w-full text-white bg-gray-900">
      <div className="bg-gray-800 w-[90%] md:w-[40%] rounded-lg border p-4 md:p-10">
        ...
        <form
          ...
          className="flex items-center gap-y-4 flex-col"
        >
          <p className="text-2xl font-semibold">Enter Room ID</p>
          <input
            className="w-full rounded-md px-2 py-2 border-2 border-black text-black"
            value={roomid}
            onChange={(e) => {
          ...
          />
          <button className="bg-green-600 px-2 py-2 rounded-md font-semibold hover:bg-green-700 transition-all ease-in duration-200">
            Join Room
          </button>
        </form>
      ...
      <div>
        <a href="https://github.com/Anubhav-Ghosh1" target="_blank">
          <p className="text-sm text-gray-400 mt-5">
            © 2025 Made by Anubhav Ghosh. All rights reserved.
          </p>
        </a>
      </div>
    </div>
